...
void Lab2::Init()
{
...

    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0, 1, 0.5), glm::vec3(0.2, 0.8, 0.6)),
        ...
        meshes["tetrahedron_A"] = new Mesh("tetrahedron");
        meshes["tetrahedron_A"]->InitFromData(vertices, indices);
    }
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(3, 4, 2), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(5, 4, 2), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, 2, 2), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(5, 2, 2), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        };
        ...
        meshes["square_A"]->InitFromData(vertices, indices);
    }
    ...
    // BONUS
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(1, 0.5, 0), glm::vec3(0.2, 0.8, 0.6)), // 0
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 1
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0.8, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // 2

            VertexFormat(glm::vec3(-1, 1, -1), glm::vec3(1, 0.5, 1), glm::vec3(0.2, 0.8, 0.6)), // 3
            VertexFormat(glm::vec3(-1, 1, -1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 4
            VertexFormat(glm::vec3(-1, 1, -1), glm::vec3(0.8, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // 5

            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(1, 0.5, 0), glm::vec3(0.2, 0.8, 0.6)), // 6
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 7
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(0.8, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // 8

            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(1, 0.5, 0), glm::vec3(0.2, 0.8, 0.6)), // 9
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 10
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0.8, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // 11  
        };
        ...
        meshes["tetrahedron_B"] = new Mesh("tetrahedronB");
        meshes["tetrahedron_B"]->InitFromData(vertices, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetrahedron_A"], shaders["VertexColor"], glm::vec3(4.5f, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square_A"], shaders["VertexColor"], glm::vec3(7.5f, 0.5f, 0), glm::vec3(0.25f));

    // BONUS
    RenderMesh(meshes["tetrahedron_B"], shaders["VertexColor"], glm::vec3(6.5f, 0.5f, 0), glm::vec3(0.25f));

    RenderMesh(meshes["circle"], shaders["VertexColor"], glm::vec3(10.f, 2.f, 1.5f));
