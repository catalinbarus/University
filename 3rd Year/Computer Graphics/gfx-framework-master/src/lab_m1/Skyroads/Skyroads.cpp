...
#include "lab_m1/Skyroads/Transform.h"
...
void Skyroads::Init()
{
	...
	// Create a shader program for drawing face polygon with the color of the normal
	{
		...
		shader->AddShader(PATH_JOIN(window->props.selfDir, SOURCE_PATH::M1, "Skyroads", "Shaders", "VertexShader.glsl"), GL_VERTEX_SHADER);
		shader->AddShader(PATH_JOIN(window->props.selfDir, SOURCE_PATH::M1, "Skyroads", "Shaders", "FragmentShader.glsl"), GL_FRAGMENT_SHADER);
