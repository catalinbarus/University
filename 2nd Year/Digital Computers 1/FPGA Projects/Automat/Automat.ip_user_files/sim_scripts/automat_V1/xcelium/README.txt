...
#
# Generated by export_simulation on Tue Jun 01 21:26:10 EEST 2021
#
################################################################################
...
'-reset_run' switch to the './automat_V1.sh' script.

./automat_V1.sh -reset_run
...
./automat_V1.sh -noclean_files

For more information on the script, please type './automat_V1.sh -help'.
