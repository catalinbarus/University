...
public class Main {
    ...
    private static void printBankReport() {
		...
		BankReport.getNumberOfCustomers(bank);
		...
		BankReport.getCustomersSorted(bank);
		...
		BankReport.getCustomersByCity(bank);
		...
		BankReport.getProjectWorkedOnByMostCustomers(bank);
		...
		BankReport.getGenderWhoWorkedOnMostProjects(bank);
    ...
    private static void printBusinessReport() {
		...
		BusinessReport.getEmployeesOnSameDisability(business1);
		...
		System.out.println("---------------- getNumberOfProjectsWorkedByCurrentEmployees test --------------");
		System.out.println();
		System.out.println();

		BusinessReport.getNumberOfProjectsWorkedByCurrentEmployees(business1);
		...
		System.out.println("---------------- getEmployeesMaxByReligionMaxByGenderSortedByCitySortedByAge test --------------");
		System.out.println();
		System.out.println();

		BusinessReport.getEmployeesMaxByReligionMaxByGenderSortedByCitySortedByAge(business1);
		...
		BusinessReport.getReligionOfEmployeesWithMostAccounts(business1);
		...
		BusinessReport.getEmployeesOnSameProjectAndCity(business1);
		...
		BusinessReport.getEmployeesOnSameReligionAndGender(business1);
